# Open vAIR contract (mutated benchmark): network
...
layers:
  adapters:
    ...
    - name: NetworkSqlAlchemyRepository
      methods:
      - get_by_name
    - name: PhantomRde_network_adapters_1
      methods:
      - run
    - name: PhantomRde_network_adapters_2
      methods:
      - run
    - name: PhantomRde_network_adapters_3
      methods:
      - run
    - name: PhantomRde_network_adapters_4
      methods:
      - run
    - name: PhantomRde_network_adapters_5
      methods:
      - run
  domain:
    required_classes:
